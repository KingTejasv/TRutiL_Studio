...
const currentPath = '/C:/Users/tejas/.gemini/antigravity/scratch/toolverse/tools/Business%20&%20Finance/Corporate%20&%20Startup/hub.html';
...
if (parts.length > 1) {
    ...
    if (afterTools.length >= 2 && afterTools[1] !== 'hub.html') {
...
if (isInsideSubHub && navData[currentMainCategory]) {
    ...
    html += `<a href="${prefix}hub.html" class="nav-home"><span class="ni">🏠</span> Main Hub</a>`;
