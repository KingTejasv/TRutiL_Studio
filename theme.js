...
(function() {
    ...
    window.addEventListener('DOMContentLoaded', () => {
        ...
        // --- Ad Injection System ---
        if (!document.querySelector('.tv-ad-system-initialized')) {
            document.body.classList.add('tv-ad-system-initialized');
            
            // 1. Bottom Banners
            const bottomAd = document.createElement('div');
            bottomAd.className = 'tv-bottom-ad-container';
            bottomAd.style.cssText = 'width: 100%; display: flex; justify-content: center; padding: 20px 0; margin-top: 20px;';
            bottomAd.innerHTML = `
                <style>
                    .tv-bottom-ad-container iframe { max-width: 100%; border: none; overflow: hidden; background: transparent; }
                ...
                <iframe src="${prefix}ads/banner-468x60.html" width="468" height="60" scrolling="no" class="ad-desktop"></iframe>
                <iframe src="${prefix}ads/banner-300x250.html" width="300" height="250" scrolling="no" class="ad-mobile"></iframe>
            `;
            
            const mainContainerForAd = document.querySelector('.main-container') || document.querySelector('.main-content');
            const existingFooter = document.querySelector('.tv-footer');
            if (mainContainerForAd && existingFooter) {
                mainContainerForAd.insertBefore(bottomAd, existingFooter);
            } else if (mainContainerForAd) {
            ...
            rightAd.innerHTML = \`
                <style>
                    ...
                    @media (min-width: 1300px) {
                        .tv-right-rail-ad { display: block; }
                        .ad-skyscraper-large { display: none; }
                        .ad-skyscraper-small { display: block; }
                    }
                    @media (min-width: 1500px) {
                        .ad-skyscraper-large { display: block; }
            ...
            */
            ...
            if (mainContainerForAd && existingFooter) {
                mainContainerForAd.insertBefore(nativeAd, existingFooter);
            }
            const sNative = document.createElement('script');
            sNative.src = 'https://pl29637445.effectivecpmnetwork.com/7f325836a1527e8007557cb927b0a1be/invoke.js';
            sNative.async = true;
    ...
    "Media & Design": {
        "Audio & Video": [
            ...
            },
            {
                ...
                "path": "Media & Design/Audio & Video/mediaworks-audio-extractor.html"
            },
            {
                "name": "Video Compressor",
                "path": "Media & Design/Audio & Video/mediaworks-video-compressor.html"
            },
            {
                "name": "Audio Trimmer",
        ...
        "Image & Color Tools": [
            {
                ...
                "path": "Media & Design/Image & Color Tools/mediaworks-image-converter.html"
            }
        ],
        "PDF & Documents": [
            {
